...
public class Digitalmarketing_AppAdapter extends RecyclerView.Adapter<Digitalmarketing_AppAdapter.ViewHolder> {
    ...
    public Digitalmarketing_AppAdapter(ArrayList<AppModel> appModelArrayList, Context context) {
    ...
    @NonNull
    @Override
    public Digitalmarketing_AppAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.digitalmarketing_corses, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Digitalmarketing_AppAdapter.ViewHolder holder, final int position) {
