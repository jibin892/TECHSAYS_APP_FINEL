...
public class Digitalmarketing_details extends AppCompatActivity implements Android_AppAdapter.CodexRecyclerViewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digitalmarketing_details);
