...
public class Android_AppAdapter extends RecyclerView.Adapter<Android_AppAdapter.ViewHolder> {
    ...
    public Android_AppAdapter(ArrayList<AppModel> appModelArrayList, Context context) {
    ...
    @NonNull
    @Override
    public Android_AppAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.android_corses, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Android_AppAdapter.ViewHolder holder, final int position) {
